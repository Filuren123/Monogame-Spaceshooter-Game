...
namespace Spaceship_Game_Slutprojekt
{
    public class Game1 : Game
    {
        ...
        public static SpriteFont Font_Georgia_49;
        ...
        public static int currentScene = (int)scenes.mainMenu;
        ...
        protected override void LoadContent()
        {
            ...
            Font_Georgia_49 = Content.Load<SpriteFont>("system_fetare");
